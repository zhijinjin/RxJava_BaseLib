package com.zjj.widgetlibrary.downloadbutton;
...
public class DownloadProgressButton  extends AppCompatTextView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            ...
            @Override
            public DownloadProgressButton.SavedState createFromParcel(Parcel in) {
                return new DownloadProgressButton.SavedState(in);
            }

            @Override
            public DownloadProgressButton.SavedState[] newArray(int size) {
                return new DownloadProgressButton.SavedState[size];
            }
        };
    }
